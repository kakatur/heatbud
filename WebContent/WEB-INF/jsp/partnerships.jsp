...
<html><head>
    ...
    <title>Heatbud - Partnerships</title>
	...
	<div style="padding: 78px 100px 0px 100px">
		...
		Want to partner with Heatbud and help yourself grow? You're at the right place! We're looking for partners who are...<br>
		</div>
	
		<br><br>
		<div class="profileLabel h1"><span style="border-bottom: 5px solid rgb(139, 197, 62); padding-bottom:4px">Blog Syndicators</span></div>
		<div class="profileDiv">
		Heatbud receives hundreds of posts everyday and our top posts are published through <a target="_blank" href="https://www.heatbud.com/do/rss">RSS feeds</a>. If you're a blog syndicator, you are welcome to subscribe to our feeds and provide your readers with access to high quality content.<br>
		<b>Copying Blog Content into your website is prohibited.</b>
		<br>
		Our Syndication Partners:<br>
		<div style="float:left; margin-top:17px">
			<a target="_blank" href="http://alltop.com/"><img style="height:125px" src="http://badges.alltop.com/images/alltop_125x125.jpg" width="125" height="125" alt="Alltop, all the top stories" /></a>
		</div>
		<div style="float:left; margin-left:20px">
			<a href="http://ontoplist.com" target="_blank"><img style="height:125px" src="http://www.ontoplist.com/images/ontoplist51.png?id=54f695e612505" alt="Blog Directory & Business Pages - OnToplist.com" border="0" /></a>
		</div>
		<div style="float:left; margin-left:20px">
		...
		<div class="profileLabel h1"><span style="border-bottom: 5px solid rgb(139, 197, 62); padding-bottom:4px">Collaborative Game Developers</span></div>
		<div class="profileDiv">
		Heatbud is all about Collaborative Networking, which is a step above Social Networking. We're looking to host collaborative games that are designed to develop skills related to collaboration and teamwork.<br>
		Typical characteristics of collaborative games:
		<ul>
		<li>Any number of players can play the game simultaneously.</li>
		<li>Players are allowed to join or leave the game any time.</li>
		<li>There is no winning or losing.</li>
		<li>Players may be awarded points which can be exchanged for badges or other interesting stuff.</li>
		<li>Top Players are recognized in Daily, Weekly and All-time top charts.</li>
		<li>Games are designed to improve collaboration and teamwork skills.</li>
		</ul>
		</div>

		<br>
		<div style="padding-left:80px; padding-right:80px">
		Please do <a href="/do/contact">Contact Us</a> so we can work together.
		</div>
