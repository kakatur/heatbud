...
<html><head>
    ...
    <title>Heatbud - Comment Already Confirmed</title>
	...
	<div style="padding: 78px 100px 0px 100px">
		...
		Your comment has already been confirmed.<br><br>
		You can verify this by clicking the Post Title in the email.<br><br>
		</div>
	</div>
	<br><br>
	<br><br>
