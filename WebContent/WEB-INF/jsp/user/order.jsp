...
<body style="position:relative">
	...
	<table class="header"><tr style="width:100%">
		...
		<td style="float:right; font-size:13px; padding-top:14px; padding-bottom:6px">
			...
			<div style="float:left; margin-right:8px"><a target="_self" href="/post/singing-bowls-singing-bowls-a-do-it-yourself-method-to-wellness" class="mainSelection">BLOG POSTS</a></div>
