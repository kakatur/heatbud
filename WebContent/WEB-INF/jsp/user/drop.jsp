...
<html><head>
	...
	<title>Heatbud - Drop Account</title>
	...
	<script src="/resources/js/heatbud-drop-min.js?5"></script>
...
<body style="position: relative">
	...
	<%-- Begin page content --%>
	<table style="width: 100%; border-spacing: 2px; padding:88px 10px 10px 10px">
		<tr style="width: 100%">
			<td style="width: 80%; vertical-align: top; padding: 0px">
				...
				<div class="h1" style="margin-left:30px; margin-top:40px; margin-bottom:30px; font-size:15px; font-weight:bold">
					<span style="border-bottom: 5px solid rgb(139, 197, 62); padding-bottom: 4px">DROP ACCOUNT</span>
				</div>
				<div style="margin-left: 40px">

					<div class="accountLabel" style="float:none; margin-top:0px">To drop your Heatbud account, <a id="dropAccount" href="javascript:">click here</a>.</div>
					<div style="margin-top:10px; color:#4e9258">Caution: Your posts will be permanently dropped and the contents will not be retrievable.</div>
					<div style="margin-left:160px; margin-top:10px; color:red" id="dropAccountRetMessage"></div>
					<br>
