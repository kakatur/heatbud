...
<html><head>
    ...
    <title>Heatbud | Page Payment Success</title>
...
<body style="position: relative">
	...
	<div class="profileDiv" style="white-space:normal; width:87%; margin-left:4%">
		...
		<c:if test="${empty ERROR}">
			...
			<div style="margin:20px 0px 60px 40px">To check if your payment has been posted correctly, please visit <a href="/user/page-payments/${pageId}">Manage Page Payments</a>.</div>
		</c:if>
	</div>
	<%-- End page content --%>
