...
<html><head>
    ...
    <title>Heatbud | Page Payment Error</title>
...
<body style="position: relative">
	...
	<div class="profileLabel h1" style="width:87%; margin-top:10px; margin-left:4%">
		<span style="margin-left:36px; border-bottom:5px solid rgb(139, 197, 62); padding-bottom:4px">ERROR/ CANCEL</span>
	</div>
	<div class="profileDiv" style="white-space:normal; width:87%; margin-left:4%">
		<div style="margin:20px 0px 0px 40px">Your transaction did not complete.</div>
		<div style="margin:20px 0px 60px 40px">Click <a href="/user/page-payment/${paymentHandler}">here</a> to retry the transaction.</div>
		<c:if test="${pageId != 'NULL'}">
			<div style="margin:20px 0px 60px 40px">Visit <a href="/user/page-payments/${pageId}">Manage Page Payments</a> to make a new transaction.</div>
		</c:if>
	</div>
	<%-- End page content --%>
