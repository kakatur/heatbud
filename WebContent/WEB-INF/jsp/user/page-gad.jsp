...
<html><head>
    ...
    <title>Heatbud | Page Google Analytics</title>
	...
	<script src="/resources/js/heatbud-page-gad-min.js?20180530"></script>
...
<body style="position: relative; background-color:rgb(248, 250, 252)">
	...
	<div style="width:87%; margin-left:4%; margin-top:10px; text-align:center">
		<div style="font-weight:bold; font-size:1.3em">Google Analytics for</div>
		<div style="color:#498; font-size:1.4em"><a target="_blank" href="https://www.heatbud.com/${pageId}">https://www.heatbud.com/${pageId}</a></div>
		<div>
			<select id="startDate" name="startDate" onchange="createCharts(document.getElementById('startDate').value);" style="border: 2px solid #BDC7D8; padding:4px 10px 4px 10px">
				<option value="7daysAgo">Past 7 days</option>
				<option value="30daysAgo">Past 30 days</option>
			</select>
		</div>
	</div>
	<div style="width:87%; margin-left:4%; margin-top:10px; white-space:normal">
		<c:if test="${pageId == 'NULL'}">
			<div style="margin-left:26px">Page doesn't exist.</div>
		</c:if>
		<c:if test="${pageId != 'NULL'}">
			...
			<div style="margin-left:26px">
				<div style="display:inline-block">
					<h3 style="color:#498">Users/ Page Views</h3>
					<section id="chart1">
						<img alt="Loading..." style="width:40px; border:none" src="/resources/images/loading.gif"/>
					</section>
				</div>
				<div style="display:inline-block; margin-left:50px">
					<h3 style="color:#498">Users by Country</h3>
					<section id="chart2">
						<img alt="Loading..." style="width:40px; border:none" src="/resources/images/loading.gif"/>
					</section>
				</div>
				<h3 style="color:#498">Referring Websites</h3>
				<section id="chart3">
					<img alt="Loading..." style="width:40px; border:none" src="/resources/images/loading.gif"/>
				</section>
			</div>
