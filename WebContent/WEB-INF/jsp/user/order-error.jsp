...
<html><head>
    ...
    <title>Heatbud | Order Payment Error</title>
...
<body style="position: relative">
	...
	<div class="profileDiv" style="white-space:normal; width:87%; margin-left:4%">
		...
		<div style="margin:20px 0px 60px 40px">Click <a href="/user/order-payment/${orderHandler}">here</a> to retry the transaction.</div>
